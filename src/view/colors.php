...
class ColorView
{
    public function __construct(ColorController $controller)
    {
        $this->controller = $controller;
        $this->template = DIR_TEMPLATE . "colors.php";
    }
    ...
    public function render()
    {
        ...
        $message = "";
        $detailPage = "Ajouter une couleur";
        ...
        if (!empty($_POST)) {
            ...
            if (isset($_GET["operation"]) && $_GET["operation"] == "delete") {
                ...
                $detailPage = "Modifier une couleur";
